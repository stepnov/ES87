...
export const usersSchema = TypeBox.Type.Object({
    id: TypeBox.Type.String({ format: 'uuid' }),
        ...
        emailVerified: TypeBox.Type.Boolean({ default: false }),

        emailVerificationToken: TypeBox.Type.String({ default: '' }),

        emailVerificationTokenExpiresAt: TypeBox.Type.String({ format: 'date-time' }),

        passwordResetToken: TypeBox.Type.String({ default: '' }),

        passwordResetTokenExpiresAt: TypeBox.Type.String({ format: 'date-time' }),

        provider: TypeBox.Type.String({ default: '' }),
